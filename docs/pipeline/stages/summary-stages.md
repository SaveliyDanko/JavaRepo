...
**Готовность к разработке:** нет — детализация в процессе (3 из 4 stages детализированы)
...
| 04 | README ветки + DoD             | README под тему + ссылка на сводку; финальный `./gradlew test` зелёный | 02, 03     | todo               | 04-readme-and-dod.md          |
